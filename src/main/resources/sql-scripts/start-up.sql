...
insert into user_(email, name, password) values('admin@example.com', 'Dummy Admin', '$2a$10$dPEuQh2zNKSuF8rMneLgY.0DAmaWY22xkl2sWaWfHeLGvcSYfrOWK');
insert into roles(role) values('CUSTOMER'), ('ADMIN');
insert into `user__roles`(username, role_id) values('admin@example.com', 1), ('admin@example.com', 2);